...
print("==========================================")
print("OCI Bastion Tunnel Automation with Python")
print("==========================================")

# Ask for local private key if it's not declared in the .env file
env_key = None
...
# Extract Bastion ID from Terraform
...
# Create and manage bastion tunnels using oci cli
pids = []

oci_cmd = "oci"
# Check if we're in a python virtual environment and if not, use the binary directly from the venv folder
