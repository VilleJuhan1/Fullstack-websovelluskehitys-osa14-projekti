...
graph TD
    ...
    MasterVM -- "ArgoCD Polls Repos<br/>(Outbound via IGW + NSG rules)" --> IGW
    AgentVM1 -- "Pull Images / Outbound<br/>(Via IGW + NSG rules)" --> IGW
    AgentVM2 -- "Pull Images / Outbound<br/>(Via IGW + NSG rules)" --> IGW
