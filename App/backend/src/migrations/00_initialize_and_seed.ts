...
/**
 * Migration file that initializes the database tables and seeds them with initial data
 * from countries and pokemon json files on which the app was initially developed with
